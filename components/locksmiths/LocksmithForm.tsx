...
const LocksmithForm: React.FC<LocksmithFormProps> = ({
  initialData,
  onSubmit,
  onCancel,
  isSubmitting,
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 max-h-[calc(100vh-200px)] overflow-y-auto">
      <div className="space-y-4">
        {/* Association utilisateur - Only visible for admin users */}
        {user?.role === "admin" && (
          <div className="p-4 border rounded-lg bg-muted/50">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Entrez l'identifiant Firebase de l'utilisateur à associer à cette fiche serrurier (optionnel)
              </p>
              {errors.userId && (
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between">
              <Label htmlFor="is24h">Disponible 24h/24</Label>
              <Controller
              ...
              <div className="mt-4 space-y-2">
                {(["monday", "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday"] as Day[]).map((day) => (
                  <div key={day}>
                    ...
                    <Input
                      id={day}
                      {...register(`workingHours.schedule.${day}` as const)}
                      className="mt-1"
                    />
                  </div>
                ))}
